...
fn main() -> Result<(), Box<dyn std::error::Error>> {
    println!("Fugue - AM Synthesis Example");
    println!("============================\n");

    // Load AM synthesis patch
    let patch = Patch::from_file("examples/am_synthesis.json")?;
    ...
    println!("You should hear tremolo effect (LFO modulating carrier amplitude)");
    println!();
